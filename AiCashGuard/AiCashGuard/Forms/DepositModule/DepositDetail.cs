...
{
	public partial class DepositDetail : BaseForm
	{
		...
		private void DisplayTransactions(List<CreateDepositModel> deposits)
		{
			...
			{
				var TransactionRow = new DepositDetail_row(this);
		...
		public void UpdateCheckboxCount()
		{
			...
			{
				if (control is DepositDetail_row customRow && customRow.IsSelected != null)
				{
			...
			TotalChecks.Text = count.ToString();
			DepositAmount.Text = total_amount.ToString();
		}
